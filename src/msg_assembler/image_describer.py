...
MEDIA_DIR = BASE_DIR / 'src' / 'msg_assembler' / 'tmp_storage' / 'images'
...
async def process_photo_messages(session: AsyncSession, photo_msgs: list[LocalRawMessages]) -> list[LocalRawMessages]:
    ...
    for msg in photo_msgs:
        ...
        try:
            ...
            photo_path = await download_file(msg.file_id, MEDIA_DIR, "jpeg")
